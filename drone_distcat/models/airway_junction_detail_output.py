...
class AirwayJunctionDetailOutput(BaseModel):
    """
    AirwayJunctionDetailOutput
    """ # noqa: E501
    airway: AirwayGeometry
    deviation: Deviation
    __properties: ClassVar[List[str]] = ["airway", "deviation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of airway
        if self.airway:
            _dict['airway'] = self.airway.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "airway": AirwayGeometry.from_dict(obj["airway"]) if obj.get("airway") is not None else None,
