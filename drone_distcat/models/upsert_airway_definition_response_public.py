...
class UpsertAirwayDefinitionResponsePublic(BaseModel):
    """
    A class to read data from the Airway table
    """ # noqa: E501
    airway: AirwayOutput
    __properties: ClassVar[List[str]] = ["airway"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "airway": AirwayOutput.from_dict(obj["airway"]) if obj.get("airway") is not None else None
        })
        return _obj
