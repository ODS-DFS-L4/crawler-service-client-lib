...
class AreaOfInterest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["outline_polygon"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of outline_polygon
        if self.outline_polygon:
            _dict['outline_polygon'] = self.outline_polygon.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outline_polygon": BBoxDefinition.from_dict(obj["outline_polygon"]) if obj.get("outline_polygon") is not None else None
        })
        return _obj
