...
class DiscoveryServiceListRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["available_services"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in available_services (list)
        _items = []
        if self.available_services:
            for _item_available_services in self.available_services:
                if _item_available_services:
                    _items.append(_item_available_services.to_dict())
            _dict['available_services'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "available_services": [SingleDiscoveryServiceDetail.from_dict(_item) for _item in obj["available_services"]] if obj.get("available_services") is not None else None
        })
        return _obj
