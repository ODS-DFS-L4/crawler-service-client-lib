...
class CreateOrUpdateDronePortReferenceResponse(BaseModel):
    """
    CreateOrUpdateDronePortReferenceResponse
    """ # noqa: E501
    id: StrictStr
    drone_port_details: DronePortDetails
    __properties: ClassVar[List[str]] = ["id", "drone_port_details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of drone_port_details
        if self.drone_port_details:
            _dict['drone_port_details'] = self.drone_port_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "drone_port_details": DronePortDetails.from_dict(obj["drone_port_details"]) if obj.get("drone_port_details") is not None else None
        })
        return _obj
