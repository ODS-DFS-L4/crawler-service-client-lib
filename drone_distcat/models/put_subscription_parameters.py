...
class PutSubscriptionParameters(BaseModel):
    ...
    time_start: datetime
    time_end: datetime
    sp_base_url: StrictStr
    __properties: ClassVar[List[str]] = ["area_of_interest", "time_start", "time_end", "sp_base_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of area_of_interest
        if self.area_of_interest:
            _dict['area_of_interest'] = self.area_of_interest.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "area_of_interest": AreaOfInterest.from_dict(obj["area_of_interest"]) if obj.get("area_of_interest") is not None else None,
            "time_start": obj.get("time_start"),
            "time_end": obj.get("time_end"),
            "sp_base_url": obj.get("sp_base_url")
        })
        return _obj
