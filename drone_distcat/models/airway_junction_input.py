...
class AirwayJunctionInput(BaseModel):
    """
    AirwayJunctionInput
    """ # noqa: E501
    id: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "airways": [AirwayJunctionDetailInput.from_dict(_item) for _item in obj["airways"]] if obj.get("airways") is not None else None
        })
        return _obj
