...
class SubscriptionBase(BaseModel):
    ...
    """ # noqa: E501
    version: StrictStr
    notification_index: StrictInt
    sp_base_url: StrictStr
    time_start: datetime
    time_end: datetime
    __properties: ClassVar[List[str]] = ["version", "notification_index", "sp_base_url", "time_start", "time_end"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification_index": obj.get("notification_index"),
